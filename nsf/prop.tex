...
% Define custom colors for each order term
\definecolor{zerocolor}{rgb}{0.1, 0.6, 0.1}  % Green for zero-order
\definecolor{firstcolor}{rgb}{0.1, 0.1, 0.9} % Blue for first-order
\definecolor{secondcolor}{rgb}{0.9, 0.1, 0.1} % Red for second-order
